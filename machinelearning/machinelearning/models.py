...
class RegressionModel(Model):
    ...
    def run(self, x, y=None):
        ...
        if y is not None:
            ...
            loss = nn.SquareLoss(graph, nn_mm_b2, nn_y)
            return graph
            ...
            "*** YOUR CODE HERE ***"
            return graph.get_output(nn_mm_b2)
...
class OddRegressionModel(Model):
    ...
    def __init__(self):
        ...
        "*** YOUR CODE HERE ***"
        self.learning_rate = 0.01
        self.w1 = nn.Variable(1, 100) # input*w1=> batchsize X 10
        self.b1 = nn.Variable(100) #b1 should be batchsize x 10
        self.w2 = nn.Variable(100, 1)
        self.b2 = nn.Variable(1)
...
class DigitClassificationModel(Model):
    ...
    def run(self, x, y=None):
        ...
        if y is not None:
            ...
            nn_y = nn.Input(graph, y)
            loss = nn.SoftmaxLoss(graph, nn_mm_b2, nn_y)
            return graph
...
class DeepQModel(Model):
    ...
    def __init__(self):
        ...
        self.w1 = nn.Variable(self.state_size, 170)
        self.b1 = nn.Variable(170)
        self.w2 = nn.Variable(170, self.num_actions)
...
class LanguageIDModel(Model):
    ...
    def __init__(self):
        ...
        # You may use any learning rate that works well for your architecture
        "*** YOUR CODE HERE ***"
        self.w1 = nn.Variable(self.num_chars, self.j)  # input*w1=> batchsize X 10
    ...
    def run(self, xs, y=None):
        ...
        graph = nn.Graph([self.w1, self.b1, self.w2, self.b2, self.w3, self.w3_f, self.b2_f])
